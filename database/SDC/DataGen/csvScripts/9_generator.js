...
*****                                                                      *****
                  DATA GENERATION FOR listings 9000000 - 10000000  
*****                                                                      *****
********************************************************************************
********************************************************************************
*/
...
const addOneMillion = (i) => {
  ...
  fs.appendFile('./DataGen/GeneratedData/9_csvGen.csv', nameString, (err) => {
    if (err) {
...
fs.writeFile('./DataGen/GeneratedData/9_csvGen.csv', nameString, (err) => {
  if (err) {
    return console.log(err);
  }
