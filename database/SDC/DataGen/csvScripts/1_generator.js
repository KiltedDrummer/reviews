...
*****                                                                      *****
                  DATA GENERATION FOR listings 1000000 - 2000000  
*****                                                                      *****
********************************************************************************
********************************************************************************
*/
...
const addOneMillion = (i) => {
  ...
  fs.appendFile('./DataGen/GeneratedData/1_csvGen.csv', nameString, (err) => {
    if (err) {
...
fs.writeFile('./DataGen/GeneratedData/1_csvGen.csv', nameString, (err) => {
  if (err) {
    return console.log(err);
  }
