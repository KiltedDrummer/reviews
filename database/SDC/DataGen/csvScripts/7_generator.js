...
*****                                                                      *****
                  DATA GENERATION FOR listings 7000000 - 8000000  
*****                                                                      *****
********************************************************************************
********************************************************************************
*/
...
const addOneMillion = (i) => {
  ...
  fs.appendFile('./DataGen/GeneratedData/7_csvGen.csv', nameString, (err) => {
    if (err) {
...
fs.writeFile('./DataGen/GeneratedData/7_csvGen.csv', nameString, (err) => {
  if (err) {
    return console.log(err);
  }
