...
*****                                                                      *****
                  DATA GENERATION FOR listings 3000000 - 4000000  
*****                                                                      *****
********************************************************************************
********************************************************************************
*/
...
const addOneMillion = (i) => {
  ...
  fs.appendFile('./DataGen/GeneratedData/3_csvGen.csv', nameString, (err) => {
    if (err) {
...
fs.writeFile('./DataGen/GeneratedData/3_csvGen.csv', nameString, (err) => {
  if (err) {
    return console.log(err);
  }
